...
```{r viz_reconstruction}
grf <- autoplot(ts(yhat, start = c(1850, 1)))
```
### Other Steps
Additional supporting steps that glue the workflow.
```{r viz_reconstruction_layers}
