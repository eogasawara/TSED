...
```
## Warning: Removed 1 row containing missing values or values outside the scale range (`geom_tile()`).
## Removed 1 row containing missing values or values outside the scale range (`geom_tile()`).
## Removed 1 row containing missing values or values outside the scale range (`geom_tile()`).
```

![plot of chunk viz_save_draw](fig/chap2_tt_sa/viz_save_draw-1.png)
