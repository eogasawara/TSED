...
![plot of chunk plot-series](fig/chap2-frequency-discovery/plot-series-1.png)
### Other Steps
Additional supporting steps that glue the workflow.
...
```
## Estimated implicit periodicity: ~9 lags.
```
...
![plot of chunk acf-periodicity](fig/chap2-frequency-discovery/acf-periodicity-1.png)
## References
