...
```
## Warning: Removed 5 rows containing missing values or values outside the scale range (`geom_tile()`).
```

```
## Warning: Removed 6 rows containing missing values or values outside the scale range (`geom_tile()`).
## Removed 6 rows containing missing values or values outside the scale range (`geom_tile()`).
```

```
## Warning: Removed 5 rows containing missing values or values outside the scale range (`geom_tile()`).
## Removed 5 rows containing missing values or values outside the scale range (`geom_tile()`).
```

```
## Warning: Removed 4 rows containing missing values or values outside the scale range (`geom_tile()`).
## Removed 4 rows containing missing values or values outside the scale range (`geom_tile()`).
## Removed 4 rows containing missing values or values outside the scale range (`geom_tile()`).
```

```
## Warning: Removed 3 rows containing missing values or values outside the scale range (`geom_tile()`).
...
![plot of chunk viz_save](fig/chap2_tt_sw/viz_save-1.png)
## References
