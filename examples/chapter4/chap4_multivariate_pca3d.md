---
title: "Chapter 4: Multivariate PCA (3D)"
...
Extend the PCA demonstration to three variables. Compare univariate (each raw series) and the first principal component to inspect change-point visibility.
...
```
### Data Generation (3D)
Create three Gaussian series and a drift region using quadrant consistency on the first two dimensions.
...
![plot of chunk plot-scatter](fig/chap4_multivariate_pca3d/plot-scatter-1.png)
### Train/Test Framing
...
```
### PCA Projection (3D)
Project to PC1 from standardized 3D inputs and fit Chow test.
...
![plot of chunk save-figure](fig/chap4_multivariate_pca3d/save-figure-1.png)
